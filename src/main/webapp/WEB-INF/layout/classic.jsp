      ...
      <div class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<spring:url value="/" />">iMampf</a>
          </div>
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="${current == 'dishes' ? 'active' : ''}"><a href="<spring:url value="/dishes.html" />">Dishes</a></li>
              <security:authorize access="! isAuthenticated()">
	              <li class="${current == 'login' ? 'active' : ''}"><a href="<spring:url value="/login.html" />">Login</a></li>
	              <li class="${current == 'register' ? 'active' : ''}"><a href="<spring:url value="/register.html" />">Register</a></li>
              </security:authorize>
              <security:authorize access="isAuthenticated()"> 
              	<li class="${current == 'placeDish' ? 'active' : ''}"><a href="<spring:url value="/placeDish.html" />">My Dishes</a></li>                  	
